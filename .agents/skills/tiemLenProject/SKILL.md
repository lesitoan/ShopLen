...
3. **Text lặp lại luôn để trong `constants/`** của từng source — tên shop, message lỗi/thành công, label trạng thái đơn hàng, route path. Không hardcode chuỗi tiếng Việt rải rác trong component/controller.
