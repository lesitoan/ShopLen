...
export default function Button({
  ...
  const variantClasses = {
    ...
    outline: "border border-primary text-primary bg-transparent hover:bg-primary-light active:bg-primary-light/55 active:border-primary-active disabled:border-border disabled:text-text-secondary/40 disabled:active:scale-100",
